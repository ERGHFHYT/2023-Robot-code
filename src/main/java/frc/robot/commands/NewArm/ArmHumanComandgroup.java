...
//   public ArmHumanComandgroup(ArmSubsystem armSubsystem,GripperSubsys gripperSubsys ,double MidArmPosition, double BaseArmPosition ) {
...
//       new GipperCommand(gripperSubsys, 0.5)
