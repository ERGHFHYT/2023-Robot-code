...
public class CenterCloseToHumanCube extends SequentialCommandGroup {
  ...
  collectWheelsSubsystem collectWheels, ShootingSubsystem shootingSubsystem,  ArmSubsystem armSubsystem)  
  {
    ...
    new StartAuto(AutoCommand.getAutoCommand(swerve, "center - start Close To Human Cube", 3), swerve),
    new moveInParallel(swerve, collectSubsystem, collectWheels, armSubsystem, cartridgeSubsystem, AutoCommand.getAutoCommand(swerve, "center - Close To Human Cube", 3), Constants.COLLECT_OPEN_POSITION, Constants.ARM_OPEN_POSITION, 2, 0.5, false),
