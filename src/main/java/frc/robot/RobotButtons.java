...
public class RobotButtons {
    ...
    public Trigger collectWheelsBack = new Trigger(() -> systems.getRawButton(XboxController.Button.kBack.value));

    public Trigger reverseShooterTrigger = new Trigger(() -> systems.getRawButton(XboxController.Button.kStart.value));
    ...
    public  Trigger forwardShooterTrigger = new Trigger(() -> systems.getRawButton(XboxController.Button.kLeftBumper.value));
    
    public Trigger gripperTriggerOut = new Trigger(() -> systems.getRawButton(XboxController.Button.kRightBumper.value));
    public Trigger collectCone = new Trigger(() -> systems.getRawButton(XboxController.Button.kB.value));
    public Trigger restArm = new Trigger(() -> systems.getRawButton(XboxController.Button.kA.value));
    public Trigger scoreCone = new Trigger(() -> systems.getRawButton(XboxController.Button.kY.value));
    public Trigger gripperTriggerIn = new Trigger(() -> systems.getRawAxis(XboxController.Axis.kRightTrigger.value) > 0.3);
    public Trigger j = new Trigger(() -> systems.getRawButton(XboxController.Button.kX.value));
    ...
    public void loadButtons(shootingSubsystem shootingSubsystem, CollectSubsystem collectSubsystem,
        ...
        shootingHigh.onTrue(new ShootingGroupCommand(shootingSubsystem, cartridgeSubsystem, Constants.SHOOTING_HIGH, armSubsystem));
        shootinghMid.onTrue(new ShootingGroupCommand(shootingSubsystem, cartridgeSubsystem , Constants.SHOOTING_MID, armSubsystem));
        shootingLow.onTrue(new ShootingGroupCommand(shootingSubsystem, cartridgeSubsystem , Constants.SHOOTING_LOW, armSubsystem));
